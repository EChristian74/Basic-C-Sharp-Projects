...
namespace MainMethod
{
    ...
    public class Operations
    {
        ...
        public int Add(int data)  //public int = output | Add(int data) = data entry input
        {
            ...
            return data + 5;  //terminates the execution of the method in which it appears and returns the control back to the calling method
        }
        ...
        public int Dec(decimal data)  //public int = output | Dec(decimal data data) = data entry input
        {
            ...
            return x * 5;  //terminates the execution of the method in which it appears and returns the control back to the calling method
        }
        ...
        public int Integer(string data)  //public int = output | Integer(int data) = data entry input
        {
            ...
            return y / 5;  //terminates the execution of the method in which it appears and returns the control back to the calling method
        }
